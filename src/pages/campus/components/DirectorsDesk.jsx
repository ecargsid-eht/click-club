...
function DirectorsDesk() {
  return (
      <>
          <motion.div className="row mx-auto justify-content-between align-items-center shadow p-3 border border-1 rounded-4" style={{ borderColor: '#f8f8f8' }} initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
