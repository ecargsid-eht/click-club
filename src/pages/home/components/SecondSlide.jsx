    ...
    return (
        <div className="slide slide2 h-100">
            <div className="d-flex flex-column justify-content-center text-center col-lg-5">
                <motion.p initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 1 }} className='z-1 fw-normal fs-1 mb-1'>Who we are?</motion.p>
                <motion.p initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 1 }} className='z-1 fs-4 text-center mx-2' style={{ fontFamily: "Poppins", fontWeight: "200" }}>
